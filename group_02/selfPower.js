...
/**
 * 打印出所有的“水仙花数”；
 * 所谓“水仙花数”是指一个三位数，其各位数字三次方和等于该数本身；
...
/**
 * 打印出所有的“四叶玫瑰数”；
 * 所谓“四叶玫瑰数”是指一个四位数，其各位数字四次方和等于该数本身；
 * 例如：1634是一个“四叶玫瑰数”，因为1634=1的四次方+6的四次方+3的四次方+4的四次方；
 * 程序分析：利用for循环控制1000-9999个数，每个数分解出个位，十位，百位，千位。
 */
function rose() {
  let units = 0;
  let tens = 0;
